...
public class PandLReader
{
    ...
    public void readPandLtoHashMap()
    {
        ...
        System.out.println("PandL Read to HashMap In PandLreader Compelete, HashMap size => " + pandlHashMap.size());
    }
    public HashMap<String, Integer> getPandlHashMap()
    {
        return pandlHashMap;
    }
    public int get43410CorporateContrbutions()
    {
        return pandlHashMap.get("43455 Grants");
    }
}
